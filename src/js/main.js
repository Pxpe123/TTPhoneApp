...
const pages = {
  home: {
    btn: document.getElementById("homePageBtn"),
    path: "./pages/home.html",
    setup: setupHome,
  },
  user: {
    btn: document.getElementById("userPageBtn"),
  ...
  storage: {
    ...
    path: "./pages/storage.html",
    setup: null,
  },
  dealership: {
    btn: document.getElementById("dealershipPageBtn"),
    path: "./pages/dealership.html",
    setup: setupDealershipPage,
  },
  settings: {
    btn: document.getElementById("settingsPageBtn"),
...
async function InitialSetup() {
  try {
    ...
    alert(
      "Error during InitialSetup:",
      error,
      "Please Restart the app or Contance @Peps1co"
    );
  }
}
